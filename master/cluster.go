...
func (c *Cluster) migrateDisk(nodeAddr, diskPath, dstAddr string, raftForce bool, limit int, diskDisable bool, migrateType uint32) (err error) {
	...
	// disk should decommission all the dp
