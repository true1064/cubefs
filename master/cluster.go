...
func (c *Cluster) allDataNodes() (dataNodes []proto.NodeView) {
	...
	c.dataNodes.Range(func(addr, node interface{}) bool {
		...
		dataNodes = append(dataNodes, proto.NodeView{
			...
			IsActive: dataNode.isActive, ID: dataNode.ID, IsWritable: dataNode.IsWriteAble(), MediaType: dataNode.MediaType,
		})
		return true
	})
	return
...
func (c *Cluster) allMetaNodes() (metaNodes []proto.NodeView) {
	...
	c.metaNodes.Range(func(addr, node interface{}) bool {
		...
		metaNodes = append(metaNodes, proto.NodeView{
			...
			IsActive: metaNode.IsActive, IsWritable: metaNode.IsWriteAble(), MediaType: proto.MediaType_Unspecified,
		})
		return true
	})
	return
