...
func Test_isVaildVer(t *testing.T) {
	testCases := []struct {
		str   string
		valid bool
	}{
		...
		{"Abc_123-", true},
		{"Abc-123_", true},
		{"Abc_12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123", true},
		{"Abc_", false},
	}

	for _, c := range testCases {
		got := isVaildVer(c.str)
		if got != c.valid {
			t.Log(c.str)
		}
